def LoadMove(move_array,num_moves,Black_ELO,game_id,SQLconnect):
    ...
    if(num_moves == 1):
        ...
        MovesSQL = "INSERT INTO moves (Set5, Set10, Set15, Set20, Set30, Set40, BlackELO, Game_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
        ...
        MovesSQL = "INSERT INTO moves (Set5, Set10, Set15, Set20, Set30, Set40, Set70, BlackELO, Game_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"
        ...
        MovesSQL = "INSERT INTO moves (Set5, Set10, Set15, Set20, Set30, Set40, Set70, Set_Remain, BlackELO, Game_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
