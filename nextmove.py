...
def nextmove(BoardLayout,MovesString,UserMove,SQLconnect,BotDifficulty):
    ...
    if(Find11th != -1):
        Set10 = MovesString[Find6th:Find11th]
        SQLStatementEnd += "AND Set10 = '" + Set10 + "' "
    elif(Find6th != -1):
        Set10 = MovesString[Find6th:]
    ...
    if(Find16th != -1):
        Set15 = MovesString[Find11th:Find16th]
        SQLStatementEnd += "AND Set15 = '" + Set15 + "' "
    elif(Find11th != -1):
        Set15 = MovesString[Find11th:]
    ...
    if(Find21st != -1):
        Set20 = MovesString[Find16th:Find21st]
        SQLStatementEnd += "AND Set20 = '" + Set20 + "' "
    elif(Find16th != -1):
        Set20 = MovesString[Find16th:]
    ...
    if(Find31st != -1):
        Set30 = MovesString[Find21st:Find31st]
        SQLStatementEnd += "AND Set30 = '" + Set30 + "' "
    elif(Find21st != -1):
        Set30 = MovesString[Find21st:]
    ...
    if(Find41st != -1):
        Set40 = MovesString[Find31st:Find41st]
        SQLStatementEnd += "AND Set40 = '" + Set40 + "' "
    elif(Find31st != -1):
        Set40 = MovesString[Find31st:]
    ...
    if(Find71st != -1):
        Set70 = MovesString[Find41st:Find71st]
        SQLStatementEnd += "AND Set70 = '" + Set70 + "' "
    elif(Find41st != -1):
        Set70 = MovesString[Find41st:]
        SQLStatementEnd += "AND Set70 LIKE '" + Set70 + " %' "

    #Set 70 contruction
    if(Find71st != -1):
        Set_Remain = MovesString[Find71st:]
